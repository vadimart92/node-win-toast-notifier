...
export type NotificationInput = NotificationActionTextInput | NotificationActionSelectionInput;
export declare enum NotificationLoopingSounds {
...
export declare enum NotificationSounds {
